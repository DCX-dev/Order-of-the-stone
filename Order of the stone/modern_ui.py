...
class ModernUI:
    ...
    def draw_options_screen(self, mouse_pos: tuple, fullscreen: bool, fps_limit: int) -> Dict[str, pygame.Rect]:
    ...
    def draw_multiplayer_screen(self, mouse_pos: tuple) -> Dict[str, pygame.Rect]:
        ...
        # Subtitle
        subtitle = self.title_font.render("Connect with friends and play together", True, self.colors["text_secondary"])
        subtitle_x = (self.screen.get_width() - subtitle.get_width()) // 2
        self.screen.blit(subtitle, (subtitle_x, 120))
